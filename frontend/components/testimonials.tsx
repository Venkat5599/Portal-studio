...
const testimonials = [
  {
    quote:
      "Mantle Firewall gives agentic applications a clear way to explain, prove, and archive security decisions before value moves on-chain.",
    name: "AI DevTools Track",
    title: "Mantle-specific audit assistant",
    avatar:
  ...
  {
    quote:
      "The strongest version is not just a dashboard. It is a deployed protection loop with an AI verdict, user action, and Mantle attestation.",
    name: "Deployment Award",
    title: "Verified contract plus public demo",
    avatar:
  ...
  {
    quote:
      "Risk intelligence becomes more useful when it watches wallet clusters, protocol activity, and anomaly patterns directly from Mantle data.",
    name: "Alpha & Data Track",
  ...
  {
    quote:
      "For users, the win is simple: fewer blind signatures, clearer explanations, and a security layer that feels native to everyday Web3 flows.",
    name: "Best UI/UX Award",
    title: "Beginner-friendly AI interaction",
    avatar:
...
const companies = [
  { name: "Mantle", logo: "/mock-logos/commandr.svg" },
  { name: "DoraHacks", logo: "/mock-logos/interlock.svg" },
  { name: "Nansen", logo: "/mock-logos/focalpoint.svg" },
  { name: "Byreal", logo: "/mock-logos/acmecorp.svg" },
];
